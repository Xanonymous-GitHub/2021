<template>
    <main class="introduction-container" id="cfp-introd">
        <div class="introduction">
            <!-- first part -->
            <img src="@/assets/image/Path 740.svg" class="SITCON-text-path"/>
            ...
            <!-- first part -->
            <!-- second part -->
            <img src="@/assets/image/Path 762.svg" class="des-text-path"/>
            ...
            <div class="box-back" style="margin-top: 1000px;">
                <div class="topic-intro">
                    ...
                    <img src="@/assets/image/paper/paper.png" class="paper-image" />
                    <h2>徵稿時間</h2>
                    <div>
